...
district_aggregated_router = APIRouter()


@district_aggregated_router.get("/district/")
async def aggregate_district_data(
    ...
    try:
        aggregated_data = await DistrictDataCRUD.get_district_data(session, skip, limit)
