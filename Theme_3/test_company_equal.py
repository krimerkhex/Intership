...
def all_regions(slice_flag: bool = False) -> list:
...
REGIONS = all_regions(True)


@pytest.mark.parametrize("region", REGIONS)
def test_check_main_data_company_count(region: dict):
...
def test_check_aggregated_data_company_count():
