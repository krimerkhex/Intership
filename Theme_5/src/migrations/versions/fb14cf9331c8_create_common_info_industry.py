"""create_commin_info_industry

Revision ID: fb14cf9331c8
Revises: 8e8b10978110
Create Date: 2025-08-22 10:53:17.540202
...
revision: str = 'fb14cf9331c8'
down_revision: Union[str, Sequence[str], None] = '8e8b10978110'
...
def upgrade() -> None:
    ...
    op.create_table('common_info_industry',
                    ...
                    sa.Column('industry_id', sa.Integer(), sa.ForeignKey('industry_data.id'), unique=True),
