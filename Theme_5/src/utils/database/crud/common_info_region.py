...
class CommonInfoRegionCRUD:
    ...
    async def create_common_region_info(session: AsyncSession, data: dict):
        return await CommonInfoCRUD.create_common_info(session, data, CommonInfoRegionCRUD)
    ...
    @staticmethod
    async def calculate_common_region_info(session: AsyncSession, df: pd.DataFrame):
        return await CommonInfoCRUD.calculate_common_info(session, df, 'region', CommonInfoRegionCRUD)
