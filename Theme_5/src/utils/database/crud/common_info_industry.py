...
class CommonInfoIndustryCRUD:
    ...
    async def create_common_industry_info(session: AsyncSession, data: dict):
        return await CommonInfoCRUD.create_common_info(session, data, CommonInfoIndustryCRUD)
    ...
    @staticmethod
    async def calculate_common_industry_info(session: AsyncSession, df: pd.DataFrame):
        return await CommonInfoCRUD.calculate_common_info(session, df, 'industry', CommonInfoIndustryCRUD)
